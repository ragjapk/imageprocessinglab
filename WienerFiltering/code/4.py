...
G=fftp.fft2(g)
img = Image.open('C:/Users/IIST/Downloads/Ragja/8_SC18M003_Ragja_IP2018/2_degraded_image.png').convert('L')
img.load()
data = np.asarray( img, dtype="float64" )
img0 = Image.open('C:/Users/IIST/Downloads/Ragja/8_SC18M003_Ragja_IP2018/Book.tif').convert('L')
img0.load()
